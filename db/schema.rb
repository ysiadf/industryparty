...
ActiveRecord::Schema.define(:version => 20120518222655) do
  ...
  add_index "guests", ["industry_id"], :name => "index_guests_on_industry_id"
  ...
  create_table "hosts_parties", :id => false, :force => true do |t|
    t.integer "host_id"
    t.integer "party_id"
  end
  ...
  add_index "rsvps", ["host_id"], :name => "index_rsvps_on_host_id"
  add_index "rsvps", ["party_id"], :name => "index_rsvps_on_party_id"
